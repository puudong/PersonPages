function usersload() {
    $.post("/UsersV2.ashx?useraction=userload", { "nId": "0" }, function (data, status) {
        if (status == "success") {
            ...
            if (userinfoarr[0] == "0") {
                $("#userinfohead").html("<div id='HeadPhoto20' class='dropdown user_dropdown' ><span class='iconfont nav_user dropdown-toggle' id='dLabel' data-toggle='dropdown'></span><ul class='dropdown-menu user_downlist' role='menu' aria-labelledby='dLabel' style='margin:12px 0 0 0; padding-top:3px; border:#333333 1px solid'><li><a href='/usercentermanage/UserInfoEdit.html' class='iconfont icon-zhuye' target='_blank'>个人中心</a></li><li><a href='/resumev2/resumetool.aspx' class='iconfont icon-jianliguanli'>简历中心</a></li><li><a href='/usercentermanage/UserInfoEdit.html?type=resetpwd' class='iconfont icon-jianliguanli'>修改密码</a></li><li><a onclick=userlogout() class='iconfont icon-tuichu'>退出登录</a></li></ul></div>")
